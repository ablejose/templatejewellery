 ...
 * wrapper is left aligned (no mx-auto) so the accordion sits at the site's
 * left edge and reads wider instead of floating narrow in the centre. Mobile
 * is unchanged (container padding still governs the width below 896px).
 */
export function Faq() {
